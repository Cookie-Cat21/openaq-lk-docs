/**
 * Unofficial TypeScript client — OpenAQ Sri Lanka
 *
...
export class OpenaqLkDocsClient {
  ...
  static readonly slug = "openaq-lk-docs";
  static readonly title = "OpenAQ Sri Lanka";
   ...
   */
  async locationsLk(page = 1, limit = 50, options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.withQuery("https://api.openaq.org/v3/locations?countries_id=207&limit=100", { page, limit }, options.query), { ...options, method: "GET" });
  }
}
